  ...
  head: () => ({
    meta: [
      { title: "AI Inventory Copilot — AI Supply Chain Operating System" },
      {
        name: "description",
        content:
          "Premium AI-powered ERP and supply chain platform for electronics retail. Inventory, procurement, forecasting, logistics, and returns intelligence.",
      },
    ],
  }),
  component: Landing,
...
const FEATURES = [
  {
    ...
    desc: "Real-time SKU health, multi-warehouse stock visibility, safety-stock and reorder automation.",
    link: "/app/inventory",
  },
  {
    icon: Truck,
    title: "Logistics Analytics",
    desc: "Inbound and outbound shipment tracking with delay prediction across regions.",
    link: "/app/logistics",
  },
  {
    icon: RotateCcw,
    title: "AI Return Approval",
    desc: "Auto-classify return requests by fraud risk, condition and reverse-logistics cost.",
    link: "/app/returns",
  },
  {
    icon: TrendingUp,
    title: "Forecasting Engine",
    desc: "Sales history and demand forecasts for stock planning and analyst reports.",
    link: "/app/forecasting",
  },
  {
    icon: Building2,
    title: "Supplier Intelligence",
    desc: "Onboard, score and benchmark suppliers with live performance signals.",
    link: "/app/suppliers",
  },
] as const;
...
function Landing() {
  ...
  const totalRev = landingStats?.totalRevenue ?? 4820000;
  const delayed = landingStats?.delayedShipments ?? 31;
  const returnReasons = landingStats?.totalReturns ?? 450;
  const insights = landingStats?.insights ?? [
      ...
      <header className="sticky top-0 z-30 glass-strong border-b border-border">
        <div className="max-w-7xl mx-auto px-6 lg:px-8 h-16 flex items-center gap-4">
          ...
          <nav className="hidden md:flex items-center gap-7 text-sm text-muted-foreground mx-8">
            ...
            <a href="#enterprise" className="hover:text-foreground transition">
              Enterprise
            </a>
          </nav>
          ...
          {isSignedIn && (
            <DropdownMenu>
              ...
              <DropdownMenuContent align="end">
                <DropdownMenuLabel>{user?.email || user?.username || "Account"}</DropdownMenuLabel>
                <DropdownMenuSeparator />
          ...
          <Button asChild className="gradient-primary text-primary-foreground border-0 shadow-glow">
            <Link to={isSignedIn ? "/app/dashboard" : "/login"}>
              {isSignedIn ? "Open Dashboard" : "Sign in"} <ArrowRight className="w-4 h-4 ml-1" />
            </Link>
          </Button>
        </div>
      </header>
        ...
        <div className="relative max-w-7xl mx-auto px-6 lg:px-8 pt-20 pb-16 lg:pt-28 lg:pb-24">
          ...
          >
            ...
            <p className="mt-6 text-lg text-muted-foreground max-w-2xl leading-relaxed">
              AI-powered inventory, procurement, logistics, forecasting and returns intelligence —
              built for enterprise electronics retail operations across India.
            </p>
            <div className="mt-8 flex flex-wrap gap-3">
              <Button
                size="lg"
                asChild
                className="gradient-primary text-primary-foreground border-0 shadow-glow h-12 px-6"
              >
                <Link to={isSignedIn ? "/app/dashboard" : "/login"}>
              ...
              <Button
                ...
                variant="outline"
                asChild
                className="h-12 px-6 backdrop-blur bg-card/40"
              >
            ...
            <div className="relative rounded-2xl border border-border bg-card/60 backdrop-blur-xl shadow-elevated overflow-hidden">
              <div className="flex items-center gap-1.5 px-4 h-9 border-b border-border bg-muted/30">
                ...
                <div className="ml-3 text-[11px] text-muted-foreground">
                  ai-inventory-copilot.app/dashboard
                </div>
              </div>
              <div className="p-6 grid grid-cols-12 gap-4">
                <div className="col-span-12 md:col-span-8 grid grid-cols-2 md:grid-cols-4 gap-3">
                  {[
                    {
                      l: "Revenue",
                      v: `₹${(totalRev / 1000000).toFixed(2)}M`,
                      d: "+12.4%",
                      c: "text-success",
                    },
                    { l: "Orders", v: "12,408", d: "+8.1%", c: "text-success" },
                    { l: "Returns", v: String(returnReasons), d: "−0.4%", c: "text-success" },
                    { l: "Delayed", v: String(delayed), d: "+6", c: "text-destructive" },
                  ].map((k, index) => (
                    <motion.div
                      key={k.l}
                  ...
                  <div className="col-span-2 md:col-span-4 h-36 rounded-xl border border-border bg-background/60 p-3 relative overflow-hidden">
                    ...
                    <svg
                      viewBox="0 0 400 100"
                      className="absolute inset-x-3 bottom-2 w-[calc(100%-1.5rem)] h-24"
                    >
                      <defs>
                      ...
                      <path
                        d="M0,70 C40,60 70,50 110,55 C160,62 200,30 250,32 C300,34 340,20 400,12 L400,100 L0,100 Z"
                        fill="url(#heroSpark)"
                      />
                      <motion.path
                        d="M0,70 C40,60 70,50 110,55 C160,62 200,30 250,32 C300,34 340,20 400,12"
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center max-w-2xl mx-auto mb-14">
            ...
            <h2 className="text-3xl md:text-4xl font-semibold tracking-tight">
              A unified intelligence layer for every operation
            </h2>
            <p className="text-muted-foreground mt-4">
              Six AI-native modules, one operating system. Built for enterprise scale.
            </p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
            {FEATURES.map((f, i) => {
              ...
              return (
                <motion.div
                  key={f.title}
                  onClick={() => navigate({ to: f.link })}
                  initial={{ opacity: 0, y: 12 }}
                  whileInView={{ opacity: 1, y: 0 }}
                  viewport={{ once: true, margin: "-50px" }}
                  transition={{ delay: i * 0.05 }}
                  whileHover={{ y: -4 }}
                  className="group relative rounded-2xl border border-border bg-card p-6 shadow-card hover:shadow-elevated transition-all overflow-hidden cursor-pointer"
                >
      ...
      <section id="workflow" className="py-20 lg:py-28 relative">
        ...
        <div className="relative max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center max-w-2xl mx-auto mb-14">
            ...
            <h2 className="text-3xl md:text-4xl font-semibold tracking-tight">
              End-to-end visibility, one canvas
            </h2>
            <p className="text-muted-foreground mt-4">
              From supplier dispatch to AI-driven insight — every event, ranked and explained.
            </p>
          </div>
            ...
            {[
              {
                ...
                d: "SOC 2, role-based access, audit logs across every action.",
              },
              {
                icon: Zap,
                t: "Realtime by default",
                d: "Sub-second event streaming across warehouses and providers.",
              },
              {
                icon: BarChart3,
                t: "Built for analysts",
                d: "Composable dashboards, exportable models, embedded AI.",
              },
            ].map((b) => {
              const Icon = b.icon;
              return (
