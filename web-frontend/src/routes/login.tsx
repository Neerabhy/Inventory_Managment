...
export const Route = createFileRoute("/login")({
  head: () => ({
    meta: [
      { title: "Sign in — AI Inventory Copilot" },
      { name: "description", content: "Sign in to AI Inventory Copilot." },
    ],
  }),
  component: Login,
});
      ...
      <div className="hidden lg:flex flex-col justify-between w-1/2 p-12 relative">
        ...
        >
          <div className="text-4xl font-semibold tracking-tight leading-tight max-w-md">
            ...
            <span className="text-gradient">supply chain operations</span>.
          </div>
          <p className="text-muted-foreground mt-4 max-w-md">
            Inventory, procurement, logistics, forecasting and returns intelligence — all unified,
            all in real time.
          </p>
        </motion.div>
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                ...
                <Input
                  ...
                  placeholder="sys.admin or name@company.com"
                  value={username}
