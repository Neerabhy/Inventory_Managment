...
from backend_anti_gravity.app.models.procurement import (
    ProcurementDecision, PurchaseOrder, Supplier,
)
from backend_anti_gravity.app.schemas.procurement import (
...
async def rank_vendors_for_product(
    ...
    """
    from backend_anti_gravity.app.models.inventory import ProductSupplier
